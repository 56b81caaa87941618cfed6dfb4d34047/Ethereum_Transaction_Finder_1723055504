...
*/
Vue.component("simple_footer_component_1723055505", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            EthTracker: Real-Time Ethereum Transaction Finder
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        © 2023 EthTracker. Empowering users with instant Ethereum transaction insights. Stay connected to the blockchain.
                    </div>
                </div>
            </div>
        </footer> 
